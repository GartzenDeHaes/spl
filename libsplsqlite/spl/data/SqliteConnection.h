...
typedef RefCountPtrCast<SqliteConnection, Connection, ConnectionPtr> SqliteConnectionPtr;
typedef WeakReference<SqliteConnection, SqliteConnectionPtr> SqliteConnectionRef;
...
private:
	...
	inline SqliteConnection(const SqlLiteConnection& con) : Connection("", "", "", "") {}
...
public:
	SqliteConnection(const String& databaseFilename);
...
REGISTER_TYPEOF( 430, SqliteConnection );
REGISTER_TYPEOF( 432, SqliteConnectionPtr );
REGISTER_TYPEOF( 434, SqliteConnectionRef );
